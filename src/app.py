...
# Correct path to FINAL_WEATHER folder
final_weather_dir = os.path.join(BASE_DIR, '..')

shapefile_dir = os.path.join(final_weather_dir, 'karnataka_shape_files_taluk_district-20250307T065511Z-001', 'karnataka_shape_files_taluk_district', 'Taluk')
shapefile_path_tal = os.path.join(shapefile_dir, 'Taluk.shp')
shapefile_cpg = os.path.join(shapefile_dir, 'Taluk.cpg')
shapefile_dbf = os.path.join(shapefile_dir, 'Taluk.dbf')
shapefile_prj = os.path.join(shapefile_dir, 'Taluk.prj')
shapefile_sbn = os.path.join(shapefile_dir, 'Taluk.sbn')
shapefile_sbx = os.path.join(shapefile_dir, 'Taluk.sbx')
shapefile_shp_xml = os.path.join(shapefile_dir, 'Taluk.shp.xml')
shapefile_shx = os.path.join(shapefile_dir, 'Taluk.shx')

file_path = os.path.join(final_weather_dir, 'aifs_forecast_heat_stress.nc')
